<form action="signup.php" method="POST" name="form_signin" class="d-flex flex-col c-m-t gap border c-padding" style="--c-m-t:3rem;--gap:1rem;--c-padding: 0.8rem">
    ...
    <div class="form_input d-flex justify-between">
        ...
        <input type="password_confirm" required name="password_confirm" value="password">
    </div>
